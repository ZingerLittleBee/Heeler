...
| `Heeler.xcodeproj/project.pbxproj` | derived — regenerated by `xcodegen generate` |
| `Sources/HeelerNotificationService/Info.plist` | derived — its version keys are `$(MARKETING_VERSION)` / `$(CURRENT_PROJECT_VERSION)` references |
